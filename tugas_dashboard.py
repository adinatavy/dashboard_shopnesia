...
<style>
    ...
    .kpi-card:hover {
        ...
        box-shadow: 0 8px 30px rgba(100, 120, 200, 0.25);
    }
    .kpi-label {
        color: #8892b0;
        font-size: 0.8rem;
...
def generate_ai_summary(fdf):
    ...
    # Age group
    age_rev = fdf.groupby("age_group")["revenue"].sum().sort_values(ascending=False)
...
with tab1:
    ...
    # Revenue Trend
    st.markdown('<div class="section-header"> Tren Revenue Bulanan</div>',
                unsafe_allow_html=True)
    ...
    with col1:
        st.markdown('<div class="section-header"> Top 10 Provinsi (Revenue)</div>',
                    unsafe_allow_html=True)
    ...
    with col2:
        st.markdown('<div class="section-header"> Revenue per Kategori</div>',
                    unsafe_allow_html=True)
...
with tab3:
    ...
    with col4:
        st.markdown('<div class="section-header"> Top 10 Kota (Revenue)</div>',
                    unsafe_allow_html=True)
...
with tab4:
    ...
    with col1:
        st.markdown('<div class="section-header"> Tingkat Retur per Kategori</div>',
                    unsafe_allow_html=True)
...
with tab5:
    ...
    with col2:
        st.markdown('<div class="section-header"> Diskon vs Revenue</div>',
                    unsafe_allow_html=True)
    ...
    with col4:
        st.markdown('<div class="section-header"> Tingkat Retur per Diskon</div>',
                    unsafe_allow_html=True)
